...
(function ($) {
  ...
  function header_position(settings) {
    ...
    if (settings["header_position"] === "absolute")
      $selector.addClass("consulting_ehf_position_absolute");
    if (settings["header_position"] === "sticky")
      $selector.addClass("consulting_ehf_position_sticky");
    if (settings["header_position"] === "fixed")
      $selector.addClass("consulting_ehf_position_fixed");
  }
})(jQuery);
