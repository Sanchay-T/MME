...
(window.wpCookies = {
  ...
  get: function (e) {
    ...
    if (i) {
      ...
      return (
        -1 === (t = i.indexOf(";", n)) && (t = i.length),
        decodeURIComponent(i.substring(n + e.length, t))
      );
    }
  },
  set: function (e, t, n, i, s, r) {
    var o = new Date();
    (n =
      "object" == typeof n && n.toGMTString
        ? n.toGMTString()
        : parseInt(n, 10)
        ? (o.setTime(o.getTime() + 1e3 * parseInt(n, 10)), o.toGMTString())
        : ""),
      (document.cookie =
        e +
        "=" +
  ...
  (window.setUserSetting = function (e, t, n) {
    ...
    return (
      ...
      (e = e.toString().replace(/[^A-Za-z0-9_-]/g, "")),
      (t =
        "number" == typeof t
          ? parseInt(t, 10)
          : t.toString().replace(/[^A-Za-z0-9_-]/g, "")),
      (s = s || {}),
      n ? delete s[e] : (s[e] = t),
      wpCookies.setHash("wp-settings-" + i, s, 31536e3, r, "", o),
      wpCookies.set(
        "wp-settings-time-" + i,
        userSettings.time,
        31536e3,
