  ...
  (function (e) {
    (wp.Backbone = {}),
      (wp.Backbone.Subviews = function (e, t) {
        (this.view = e), (this._views = _.isArray(t) ? { "": t } : t || {});
      }),
      ...
      _.extend(wp.Backbone.Subviews.prototype, {
          ...
          return (
            ...
            (n = this.get(i)) &&
              (t.add
                ? _.isUndefined(t.at)
                  ? (s = n.concat(e))
                  : (s = n).splice.apply(s, [t.at, 0].concat(e))
                : (_.each(s, function (e) {
                    e.__detach = !0;
                  }),
                  _.each(n, function (e) {
            ...
            _.each(
              ...
              function (e) {
                var t = e.Views || wp.Backbone.Subviews,
                  t = (e.views = e.views || new t(e));
                (t.parent = this.view), (t.selector = i);
              },
              this
            ),
            t.silent ||
              this._attach(i, e, _.extend({ ready: this._isReady() }, t)),
            this
          );
        },
        add: function (e, t, i) {
          return (
            _.isString(e) || ((i = t), (t = e), (e = "")),
            this.set(e, t, _.extend({ add: !0 }, i))
          );
        },
        ...
        insert: function (e, t, i) {
          var n,
            i = i && i.at;
          return (
            _.isNumber(i) && (n = e.children()).length > i
              ? n.eq(i).before(t)
              : e.append(t),
            this
          );
        ...
        _attach: function (e, t, i) {
          var n,
            e = e ? this.view.$(e) : this.view.$el;
          return (
            e.length &&
              ((n = _.chain(t).pluck("views").flatten().value()),
              _.each(
                n,
                function (e) {
              ...
              this[i.add ? "insert" : "replace"](e, _.pluck(t, "el"), i),
              _.each(
                n,
                function (e) {
      ...
      (wp.Backbone.View = Backbone.View.extend({
        ...
        render: function () {
          var e;
          return (
            this.prepare && (e = this.prepare()),
            this.views.detach(),
            this.template &&
              (this.trigger("prepare", (e = e || {})),
