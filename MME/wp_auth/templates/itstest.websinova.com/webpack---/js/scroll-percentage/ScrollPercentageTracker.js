...
class ScrollPercentageTracker {
  ...
  _handleScroll() {
    const pageHeightAndViewportDifference =
      (0, _getPageHeight.getPageHeight)() -
      (0, _getViewportHeight.getViewportHeight)();
    ...
    const scrollPercentage =
      (100 * (0, _getBodyScrollTop.getBodyScrollTop)()) /
      pageHeightAndViewportDifference;
  ...
  registerPostMessageReceivers(postMessageReceiver) {
    postMessageReceiver.register(
      _receivedPostMessageTypes.START_TRACK_SCROLL_PERCENTAGE,
      this.add
    );
    postMessageReceiver.register(
      _receivedPostMessageTypes.STOP_TRACK_SCROLL_PERCENTAGE,
      this.remove
    );
  }
}
