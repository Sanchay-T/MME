...
const iframeMessagePool = ({ iframeSrc }) => {
  const eventQueue = createQueue();
  return {
    post: (type, data = {}) => {
      const iframe = (0,
      _getIframeFromDocumentQuery.getIframeFromDocumentQuery)();
      ...
      if (!iframe) {
        ...
        (0,
        _executeAllIframeMessageQueueEvents.executeAllIframeMessageQueueEvents)(
          {
            iframe,
            iframeSrc,
            eventQueue,
