...
function getExternalApiSettings() {
  ...
  (0, _booleanInvariant.booleanInvariant)(
  ...
  (0, _oneOfListInvariant.oneOfListInvariant)(
    mergedSettings.enableWidgetCookieBanner,
    "mergedSettings.enableWidgetCookieBanner",
    [false, true, _constants.ON_WIDGET_LOAD, _constants.ON_EXIT_INTENT]
  );
  (0, _stringInvariant.stringInvariant)(
