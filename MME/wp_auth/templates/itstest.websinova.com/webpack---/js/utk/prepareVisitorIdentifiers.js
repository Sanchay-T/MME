...
const prepareVisitorIdentifiers = () => {
   ...
   */
  const existingMessagesUtk = (0,
  _getMessagesUtkFromCookie.getMessagesUtkFromCookie)();
  ...
  const globalCookieOptOut = (0,
  _getGlobalCookieOptOut.getGlobalCookieOptOut)();
  const { messagesUtk, isFirstVisitorSession } = (0,
  _chooseMessagesUtk.chooseMessagesUtk)({
    existingMessagesUtk,
  });
  return {
    messagesUtk,
