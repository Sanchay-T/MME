...
exports.throttleInProductInitialMessagePopups =
  throttleInProductInitialMessagePopups;
...
function throttleInProductInitialMessagePopups({ portalId }) {
  if (
    ...
    (0, _operators.setCookie)(
      _constants.cookies.HIDE_WELCOME_MESSAGE,
      true,
      _times.default.ONE_DAY
    );
  }
}
