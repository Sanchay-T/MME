...
class EmbedScriptContext {
  ...
  getIFrameDomain() {
    ...
    const hubletString =
      this.messagesHublet === "na1" || !this.messagesHublet
        ? ""
        : `-${this.messagesHublet}`;
  ...
  getIFrameSrc() {
    const queryParams = (0, _serializeQueryParameters.serializeQueryParameters)(
    ...
    return `${this.getIFrameDomain()}/conversations-visitor/${
      this.portalId
    }/threads/utk/${this.messagesUtk}?${queryParams}`;
  }
