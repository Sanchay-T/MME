...
exports.EXPECTED_WIDGET_WILL_NOT_LOAD_CODES = exports.WIDGET_WILL_LOAD_CODES =
  void 0;
...
exports.EXPECTED_WIDGET_WILL_NOT_LOAD_CODES =
  EXPECTED_WIDGET_WILL_NOT_LOAD_CODES;

const shouldLoad = (statusCode) =>
  WIDGET_WILL_LOAD_CODES.indexOf(statusCode) > -1;

const requestFailed = (statusCode) =>
  !shouldLoad(statusCode) &&
  EXPECTED_WIDGET_WILL_NOT_LOAD_CODES.indexOf(statusCode) < 0;
...
function fetchWidgetData(
  ...
  if (
    (0, _isEmbeddedInProduct.isEmbeddedInProduct)({
      portalId,
    })
  ) {
