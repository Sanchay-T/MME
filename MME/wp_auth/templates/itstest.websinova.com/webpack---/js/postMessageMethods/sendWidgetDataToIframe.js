...
const sendWidgetDataToIframe = ({
  ...
  source.postMessage(
    JSON.stringify({
      ...
      data: Object.assign(
        ...
        widgetData,
        {},
        (0, _getIframeQueryParams.getIframeQueryParams)(embedScriptContext)
      ),
    }),
    "*"
  );
  if (
    !(0,
    _getIsUngatedForDontThrottleInitialMessageInApp.getIsUngatedForDontThrottleInitialMessageInApp)(
      widgetData
    )
  )
    (0,
    _throttleInProductInitialMessagePopups.throttleInProductInitialMessagePopups)(
      embedScriptContext
    );
  apiUsageTracker.trackSettingsUsed(
