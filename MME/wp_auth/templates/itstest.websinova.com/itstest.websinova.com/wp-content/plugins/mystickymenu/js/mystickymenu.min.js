!(function (e) {
  ...
  jQuery(document).ready(function (e) {
    ...
    if (
      ...
      1 != option.device_desktop
    )
      return !1;
    if (e(option.mystickyClass)[0]) {
      var t,
        i = document.querySelector(option.mystickyClass),
      ...
      C();
      for (
        var l = i.parentNode, c = document.createElement("div"), m = 0, p = 0;
        p < l.childNodes.length;
        p++
      )
        if (l.childNodes[p] == i) {
          m = p;
      ...
      (c.id = "mysticky-wrap"),
        c.appendChild(i),
        l.insertBefore(c, l.childNodes[m]);
      var y,
        f,
        u = i.parentNode,
        ...
        if (t >= o && (0 == s || t <= s)) {
          ...
          if (
            (0 == document.documentElement.scrollTop &&
              h.classList.remove("wrapfixed"),
            0 <= C)
          ) {
            if (C >= b)
              C >= d && i.classList.add("myfixed"),
                C >= d && h.classList.add("wrapfixed"),
                C >= d && (c.style.height = y + "px"),
                C >= d && (i.style.width = v + "px"),
                "slide" == n &&
                  ("false" == r &&
                    (h.style.top =
                      C >= d + f - x ? x + L + "px" : "-" + f + "px"),
                  y > f &&
                    "false" == r &&
                    (C < d + f && (h.style.top = "-" + y + "px"),
                    C >= d + f && (h.style.top = x + L + "px"))),
              ...
              !(E > k) && (c.style.height = ""),
                !(E > k) && (i.style.width = ""),
                "slide" == n
                  ? (!(E > k) && i.classList.remove("myfixed"),
                    !(E > k) && h.classList.remove("wrapfixed"),
                    "false" == r &&
                      E < k + f + 200 - x &&
                      (h.style.top = "-" + f + "px"))
                  : (!(E > k) && i.classList.remove("myfixed"),
                    !(E > k) && h.classList.remove("wrapfixed")),
                h.classList.remove("down"),
                h.classList.add("up"),
                "on" == r &&
                  ((h.style.top = x + L + "px"),
                  jQuery("#mysticky-nav " + option.mystickyClass).css(
                    "width",
                    v + "px"
                  ),
                  jQuery(
    ...
    function E() {
      (y = i.offsetHeight),
        parseInt(e(i).css("marginBottom")) > 0 &&
          (c.style.marginBottom = e(i).css("marginBottom")),
        "0" == y &&
          e(i)
            .children()
            .filter(":visible")
    ...
    function S() {
      (x =
        "true" == a && t > 600 && e("#wpadminbar")[0]
          ? e("#wpadminbar").height()
          : 0),
        (h.style.top = "slide" == n ? "-" + f + "px" : x + "px");
    }
    function I() {
    ...
    function P() {
      1 == w &&
        ("slide" == n &&
          ((d = e(i).offset().top + y - x),
          (k = e(i).offset().top + y - x),
          "on" == r && (k = e(i).offset().top - x)),
        "fade" == n &&
          ("false" == r &&
            ((d = e(i).offset().top - x), (k = e(i).offset().top - x)),
          "on" == r &&
            ((d = e(i).offset().top - x + y), (k = e(i).offset().top - x))));
    }
    function H() {
      1 == w &&
        y > f &&
    ...
    function N() {
      e(window).width() != L &&
        (h.classList.remove("up"),
        h.classList.remove("down"),
        e(".wrapfixed")[0] || (E(), i.style.removeProperty("width"), I()),
        C(),
        S(),
        B(),
        P(),
