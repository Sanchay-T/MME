...
function sheHeader() {
  var header = $j(".she-header-yes"),
    container = $j(
      ".she-header-yes .elementor-container, .she-header-yes.e-container"
    ),
    header_elementor = $j(".elementor-edit-mode .she-header-yes"),
    header_logo = $j(
      ".she-header-yes .elementor-widget-theme-site-logo .elementor-image, .she-header-yes .elementor-widget-image .elementor-image"
    ),
  ...
  if ($j.inArray(enabled, responsive_settings) != "-1") {
    ...
    if (typeof bottom_border_width != "undefined" && bottom_border_width) {
      var bottom_border =
        bottom_border_width["size"] + "px solid " + bottom_border_color;
    }
