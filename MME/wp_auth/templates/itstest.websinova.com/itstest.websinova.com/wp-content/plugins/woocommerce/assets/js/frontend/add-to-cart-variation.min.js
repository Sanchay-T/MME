    ...
    o =
      ...
      (t.prototype.onFindVariation = function (t, a) {
        var i = t.data.variationForm,
          ...
          t = e.data;
        if (e.count && e.count === e.chosenCount)
          if (i.useAjax) {
      ...
      (t.prototype.onFoundVariation = function (t, a) {
        ...
        a.sku ? i.wc_set_content(a.sku) : i.wc_reset_content(),
          ...
          a.dimensions
            ? r.wc_set_content($.parseHTML(a.dimensions_html)[0].data)
            : r.wc_reset_content(),
          t.$form.wc_variations_image_update(a),
          a.variation_is_visible
            ? ((c = d("variation-template")), a.variation_id)
            : (c = d("unavailable-variation-template")),
          (_ = (_ = (_ = c({ variation: a })).replace(
            "/*<![CDATA[*/",
            ""
          )).replace("/*]]>*/", "")),
          ...
          "yes" === a.is_sold_individually
            ? (o.val("1").attr("min", "1").attr("max", "").trigger("change"),
              n.hide())
            : ((i = parseFloat(o.val())),
              (i =
                isNaN(i) ||
                (i = i > parseFloat(a.max_qty) ? a.max_qty : i) <
          ...
          (a.is_purchasable && a.is_in_stock && a.variation_is_visible) ||
            (s = !1),
          (t.$singleVariation.text().trim()
            ? t.$singleVariation.slideDown(200)
            : t.$singleVariation.show()
              ...
              _ =
                (e.data("attribute_html") ||
                  ((_ = e.clone())
                    ...
                    .prop("disabled", !1)
                    .prop("selected", !1),
                  e.data("attribute_options", _.find("option" + o).get()),
                  e.data("attribute_html", _.html())),
      ...
      ($.fn.wc_variations_image_update = function (t) {
        ...
        if (t && t.image && t.image.src && 1 < t.image.src.length) {
          0 <
            i.find('li img[data-o_src="' + t.image.gallery_thumbnail_src + '"]')
