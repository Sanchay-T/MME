  ...
  (t.prototype.addRequest = function (t) {
    ...
    (t.prototype.run = function () {
      ...
      window
        ...
        .then(e.success)
        ["catch"]((t) => e.error && e.error())
        ["finally"](() => e.complete && e.complete());
    }),
    (t.prototype.onAddToCart = function (t) {
      ...
      if (a.is(".ajax_add_to_cart"))
        return (
          ...
          a.addClass("loading"),
          !1 ===
          o(document.body).triggerHandler(
            "should_send_ajax_request.adding_to_cart",
            [a]
          )
            ? (o(document.body).trigger(
            ...
            : ((e = {}),
              ...
              o(document.body).trigger("adding_to_cart", [a, e]),
    ...
    (t.prototype.updateButton = function (t, a, e, r) {
      (r = void 0 !== r && r) &&
        ...
        o(document.body).trigger("wc_cart_button_updated", [r]));
    }),
