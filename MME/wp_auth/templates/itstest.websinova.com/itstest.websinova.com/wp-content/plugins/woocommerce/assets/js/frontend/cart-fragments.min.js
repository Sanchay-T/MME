jQuery(function (r) {
  ...
  var t = !0,
    n = wc_cart_fragments_params.cart_hash_key;
  try {
  ...
  function s(e) {
    t && (localStorage.setItem(n, e), sessionStorage.setItem(n, e));
  }
  var o = {
    ...
    type: "POST",
    data: new URLSearchParams({ time: new Date().getTime() }).toString(),
  ...
  function i() {
    const e = new AbortController(),
      t = setTimeout(() => e.abort(), o.timeout);
    window
      .fetch(o.url, {
        method: o.type,
        headers: {
      ...
      .then((e) => {
        if ((clearTimeout(t), e.ok)) return e.json();
  ...
  if (t) {
    ...
    r(document.body).on("wc_fragment_refresh updated_wc_div", function () {
      ...
      r(document.body).on("wc_fragments_refreshed", function () {
        clearTimeout(e), (e = setTimeout(i, 864e5));
      }),
      r(window).on("storage onstorage", function (e) {
        n === e.originalEvent.key &&
    ...
    try {
      var c = JSON.parse(
        ...
        m = sessionStorage.getItem(n),
        _ = Cookies.get("woocommerce_cart_hash"),
        g = sessionStorage.getItem("wc_cart_created");
      if (
        ((null !== m && m !== undefined && "" !== m) || (m = ""),
        (null !== _ && _ !== undefined && "" !== _) || (_ = ""),
        m && (null === g || g === undefined || "" === g))
      )
      ...
      if (!c || !c["div.widget_shopping_cart_content"] || m !== _)
        throw "No fragment";
