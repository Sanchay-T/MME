      ...
      function (e, t, n, i) {
        ...
        return (
          ...
          (o.prototype.bind = function (t, e) {
            var n = this,
              i =
                (o.__super__.bind.apply(this, arguments), t.id + "-container");
      ...
      function (
        ...
        return (
            ...
            if (
              (null == (e = u.extend(!0, {}, this.defaults, e)).dataAdapter &&
                ...
                0 < e.minimumInputLength &&
                  (e.dataAdapter = _.Decorate(e.dataAdapter, S)),
                0 < e.maximumInputLength &&
                  (e.dataAdapter = _.Decorate(e.dataAdapter, O)),
                0 < e.maximumSelectionLength &&
                  (e.dataAdapter = _.Decorate(e.dataAdapter, E)),
                e.tags && (e.dataAdapter = _.Decorate(e.dataAdapter, A)),
                (null == e.tokenSeparators && null == e.tokenizer) ||
                  (e.dataAdapter = _.Decorate(e.dataAdapter, C)),
                null != e.query &&
                  ((r = d(e.amdBase + "compat/query")),
                  (e.dataAdapter = _.Decorate(e.dataAdapter, r))),
              ...
              null == e.resultsAdapter &&
                ((e.resultsAdapter = p),
                null != e.ajax &&
                  (e.resultsAdapter = _.Decorate(e.resultsAdapter, j)),
                null != e.placeholder &&
                  (e.resultsAdapter = _.Decorate(e.resultsAdapter, q)),
                e.selectOnClose &&
                  (e.resultsAdapter = _.Decorate(e.resultsAdapter, P))),
              null == e.dropdownAdapter &&
                (e.multiple
                  ? (e.dropdownAdapter = D)
                  : ((r = _.Decorate(D, T)), (e.dropdownAdapter = r)),
                0 !== e.minimumResultsForSearch &&
                  (e.dropdownAdapter = _.Decorate(e.dropdownAdapter, k)),
                e.closeOnSelect &&
                  (e.dropdownAdapter = _.Decorate(e.dropdownAdapter, I)),
                (null == e.dropdownCssClass &&
                  null == e.dropdownCss &&
                  null == e.adaptDropdownCssClass) ||
                  ((r = d(e.amdBase + "compat/dropdownCss")),
                  (e.dropdownAdapter = _.Decorate(e.dropdownAdapter, r))),
                (e.dropdownAdapter = _.Decorate(e.dropdownAdapter, L))),
              null == e.selectionAdapter &&
                (e.multiple
                  ? (e.selectionAdapter = f)
                  : (e.selectionAdapter = h),
                null != e.placeholder &&
                  (e.selectionAdapter = _.Decorate(e.selectionAdapter, g)),
                e.allowClear &&
                  (e.selectionAdapter = _.Decorate(e.selectionAdapter, m)),
                e.multiple &&
                  (e.selectionAdapter = _.Decorate(e.selectionAdapter, y)),
                (null == e.containerCssClass &&
                  null == e.containerCss &&
                  null == e.adaptContainerCssClass) ||
                  ((r = d(e.amdBase + "compat/containerCss")),
                  (e.selectionAdapter = _.Decorate(e.selectionAdapter, r))),
                (e.selectionAdapter = _.Decorate(e.selectionAdapter, v))),
              "string" == typeof e.language &&
                (0 < e.language.indexOf("-")
                  ? ((r = e.language.split("-")[0]),
                    (e.language = [e.language, r]))
                  : (e.language = [e.language])),
              u.isArray(e.language))
            ) {
              for (
                var t = new w(), n = (e.language.push("en"), e.language), i = 0;
                i < n.length;
                i++
              ) {
                var o = n[i],
              ...
              var r = w.loadPath(this.defaults.amdLanguageBase + "en"),
                a = new w(e.language);
          ...
          (n.prototype.set = function (e, t) {
            var n = {},
              e = ((n[u.camelCase(e)] = t), _._convertData(n));
        ...
        return (
          (e.prototype.render = function (e) {
            var n,
              ...
              i =
                (s.isFunction(t) && (t = t(this.$element)),
            ...
            return (
              ...
              r.syncCssClasses(e, this.$element, i),
              e.css(o),
              e.addClass(t),
              e
            );
