...
(function ($) {
  jQuery(window).on("elementor/frontend/init", function () {
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/etlms-course-thumbnail.default",
      function ($scope, $) {
     ...
     */
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/etlms-course-curriculum.default",
      function ($scope, $) {
        if (etlmsUtility.is_editor_mode) {
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/etlms-course-content.default",
      function ($scope, $) {
        if (etlmsUtility.is_editor_mode) {
          const accordionItemHeaders = document.querySelectorAll(
            ".tutor-accordion-item-header"
     ...
     */
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/etlms-course-carousel.default",
      function ($scope, $) {
        /**
        ...
        var carousel_arrows = $scope
          .find("#etlms_carousel_settings")
          .attr("arrows");
        var carousel_dots = $scope
          .find("#etlms_carousel_settings")
          .attr("dots");
        var carousel_transition = $scope
          .find("#etlms_carousel_settings")
          .attr("transition");
        var carousel_center = $scope
          .find("#etlms_carousel_settings")
          .attr("center");
        var smooth_scroll = $scope
          .find("#etlms_carousel_settings")
          .attr("smoth_scroll");
        var carousel_autoplay = $scope
          .find("#etlms_carousel_settings")
          .attr("auto_play");
        var carousel_auto_play_speed = $scope
          .find("#etlms_carousel_settings")
          .attr("auto_play_speed");
        var carousel_infinite_loop = $scope
          .find("#etlms_carousel_settings")
          .attr("infinite_loop");
        var carousel_pause_on_hover = $scope
          .find("#etlms_carousel_settings")
          .attr("pause_on_hover");
        ...
        carousel_infinite_loop == "yes"
          ? (carousel_infinite_loop = true)
          : (carousel_infinite_loop = false);
