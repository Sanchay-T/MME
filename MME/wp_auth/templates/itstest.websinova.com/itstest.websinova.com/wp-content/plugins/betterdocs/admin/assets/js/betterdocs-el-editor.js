          ...
          for (var i = 0; i < widgets.length; i++) {
            if (widgets[i].contains(e.target)) {
              ...
              if (icon.classList.toString().indexOf("betterdocs-icon") >= 0) {
                var dialogSelector = dialog.querySelectorAll(
                ...
                if (
                  dialog.querySelector(".betterdocs-dialog-buttons-action") ===
                  null
                ) {
                  var button = document.createElement("a");
                  var buttonText =
                    document.createTextNode("Upgrade BetterDocs");
                  ...
                  dialog
                    ...
                    .insertAdjacentHTML("afterend", button.outerHTML);
                } else {
