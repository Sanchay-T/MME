  ...
  94: function (e, t, n) {
    ...
    var c = function (e, t) {
      return function () {
        ...
        return null !==
          (n =
            null === (r = o.__current[o.__current.length - 1]) || void 0 === r
              ? void 0
              : r.name) && void 0 !== n
          ? n
          : null;
    ...
    var d = function (e, t) {
      ...
      f = function e() {
        !(function (e, t) {
          ...
          (this.currentAction = c(this, "actions")),
          (this.currentFilter = c(this, "filters")),
    ...
    (window.isEditMode = !1),
      (window.ea = {
        ...
        elementStatusCheck: function (e) {
          return (
            ...
            ((window.eaElementList = g(
              g({}, window.eaElementList),
              {},
              b({}, e, !0)
            )),
            !1)
      ...
      ea.hooks.addAction("widgets.reinit", "ea", function (e) {
        ...
        t.length && t.isotope("layout"),
          ...
          l.length && ea.hooks.doAction("teamMemberCarousel.reinit"),
          c.length && ea.hooks.doAction("postCarousel.reinit"),
      ...
      h("a").on("click", function (e) {
        var t,
          n = h(this).attr("href");
        (t = (n = void 0 === n ? "" : n).startsWith("#")) ||
          (t = (n = n.replace(localize.page_permalink, "")).startsWith("#"));
        try {
          t &&
            (h(n).hasClass("eael-tab-item-trigger") ||
              h(n).hasClass("eael-accordion-header")) &&
            h(n).trigger("click");
        } catch (e) {}
      }),
      (function (e) {
        e(document).on(
          ...
          function (t) {
            var n = e(this),
              r = n.closest(".quantity").find(".qty"),
              o = parseFloat(r.val()),
              i = parseFloat(r.attr("max")),
              a = parseFloat(r.attr("min")),
              s = r.attr("step");
            (o && "" !== o && "NaN" !== o) || (o = 0),
              ("" !== i && "NaN" !== i) || (i = ""),
              ("" !== a && "NaN" !== a) || (a = 0),
              ("any" !== s &&
                ...
                "NaN" !== parseFloat(s)) ||
                (s = 1),
              n.hasClass("nm-qty-plus")
                ? i && (i == o || o > i)
                  ? r.val(i)
                  : r.val(o + parseFloat(s))
                : a && (a == o || o < a)
                ? r.val(a)
                : o > 0 && r.val(o - parseFloat(s));
          }
        );
      })(jQuery),
      (function (e) {
