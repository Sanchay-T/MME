(() => {
  var n = {
      ...
      window.selectSearchField = function (t) {
        ...
        (function () {
          r.forEach(function (o) {
            if (
              o &&
              !o.classList.contains("tutor-js-form-select") &&
              !o.hasAttribute("noDropdown") &&
              !o.classList.contains("no-tutor-dropdown")
            ) {
              ...
              r.oninput = function (t) {
                ...
                if (0 == d(u)) {
                  var i = false;
                  o.querySelectorAll(".tutor-form-select-option").forEach(
                    function (t) {
          ...
          t.forEach(function (t) {
            if (t.nextElementSibling) {
              if (
                t.nextElementSibling.classList.contains("tutor-js-form-select")
              ) {
          ...
          Array.from(t).forEach(function (t) {
            e +=
              '\n            <div class="tutor-form-select-option">\n\t\t\t\t<span tutor-dropdown-item data-key="'
                .concat(t.value, '" class="tutor-nowrap-ellipsis" title="')
                .concat(t.text, '">')
                .concat(t.text, "</span>\n            </div>\n            ");
          });
          var r =
            '\n      <div class="tutor-form-control tutor-form-select tutor-js-form-select">\n\t\t\t<span class="tutor-form-select-label" tutor-dropdown-label>'
              .concat(
                window.wp.i18n.__("Select", "tutor"),
    ...
    1103: () => {
      window.jQuery(document).ready(function (i) {
        ...
        i(document).on(
          "click",
          '.tutor-single-course-lesson-comments button[type="submit"]',
          function (t) {
            t.preventDefault();
            var e = wp.i18n.__;
            var r = i(this);
    ...
    6470: () => {
      window.jQuery(document).ready(function (f) {
        ...
        if (f(".tutor-quiz-wrap").length) {
          if (
            !f(".tutor-table-quiz-attempts").length &&
            !f(".tutor-quiz-attempt-details").length
          ) {
        ...
        if (p.length) {
          ...
          if (v.time_limit.time_limit_seconds > 0) {
            ...
            var m =
              new Date(
                (e = t.attempt_started_at) === null || e === void 0
                  ? void 0
                  : e.replaceAll("-", "/")
              ).getTime() +
              v.time_limit.time_limit_seconds * 1e3;
            var g = new Date(
              (r = v.date_time_now) === null || r === void 0
                ? void 0
                : r.replaceAll("-", "/")
            ).getTime();
            var y = setInterval(function () {
              ...
              if (t < 0) {
                ...
                i = "EXPIRED";
                if (
                  _tutorobject.quiz_options.quiz_when_time_expires ===
                  "auto_submit"
                ) {
                  ...
                  f.ajax({
                    ...
                    success: function t(e) {
                      var r = f("#tutor-quiz-time-expire-wrapper").data(
                        "attempt-allowed"
                      );
                      var n = f("#tutor-quiz-time-expire-wrapper").data(
                        "attempt-remaining"
                      );
                      var o = "#tutor-quiz-time-expire-wrapper";
                      f(o).addClass("tutor-alert-show");
                      if (n > 0) {
                        f("".concat(o, " .tutor-quiz-alert-text")).html(
                          h(
                        ...
                        if (
                          f(
                            "".concat(o, " .flash-info span:first-child")
                          ).hasClass("tutor-icon-circle-info")
                        ) {
                          f(
                            "".concat(o, " .flash-info span:first-child")
                          ).removeClass("tutor-icon-circle-info");
                          f(
                            "".concat(o, " .flash-info span:first-child")
                          ).addClass("tutor-icon-circle-times-line");
                        }
                        p.toggleClass("tutor-quiz-time-expired");
              ...
              if (t) {
                ...
                var l = document.querySelector(
                  ".quiz-time-remaining-progress-circle svg"
                );
                if (l && s) {
                  var d = 44 - 44 * (c / 100);
                  if (c <= 0) {
    ...
    3419: () => {
      window.jQuery(document).ready(function (l) {
        ...
        function h(t) {
          var o = false;
          var i = JSON.parse(
            window.tutor_quiz_context.split("").reverse().join("")
          );
          !Array.isArray(i) ? (i = []) : 0;
          if (c() !== "question_below_each_other") {
            l(".tutor-quiz-answer-single-info").remove();
          }
          l(".tutor-quiz-answer-single").removeClass(
            "tutor-quiz-answer-single-correct tutor-quiz-answer-single-incorrect"
          );
          var a = true;
          var e = t.find("input");
          var r = t.find(
          ...
          if (f()) {
            ...
            e.each(function () {
              ...
              if (e === "radio" || e === "checkbox") {
                ...
                var n = t.is(":checked");
                if (r) {
                  t.closest(".tutor-quiz-answer-single")
                    .addClass("tutor-quiz-answer-single-correct")
                    .append(s(u("Correct Answer", "tutor")))
                    .find(".tutor-quiz-answer-single-info:eq(1)")
                    .remove();
                } else {
                  if (t.prop("checked")) {
                    t.closest(".tutor-quiz-answer-single").addClass(
                      "tutor-quiz-answer-single-incorrect"
                    );
                  }
                }
                if (r && !n) {
            ...
            if (e.length) {
              ...
              if (o === "radio") {
                if (t.find('input[type="radio"]:checked').length == 0) {
                  r.find(".answer-help-block").html(
                    '<p style="color: #dc3545">'.concat(
                      u("Please select an option to answer", "tutor"),
                      "</p>"
                    )
                  );
                  n = false;
                ...
                e.each(function (t, e) {
                  if (!l(e).val().trim().length) {
                    r.find(".answer-help-block").html(
                      '<p style="color: #dc3545">'.concat(
                        u("The answer for this question is required", "tutor"),
                        "</p>"
                      )
                    );
                    n = false;
        ...
        l(".quiz-attempt-single-question input")
        ...
        l(document).on(
          "click",
          ".tutor-quiz-answer-next-btn, .tutor-quiz-answer-previous-btn",
          function (t) {
            t.preventDefault();
            var e = l(".tutor-quiz-question-counter>span:first-child");
            var r = parseInt(
              l(this).closest("[data-question_index]").data("question_index")
            );
            ...
            if (c) {
              ...
              if (s && s.length) {
                ...
                if (l(".tutor-quiz-questions-pagination").length) {
                  ...
                  l(
                    '.tutor-quiz-questions-pagination a[href="' + c + '"]'
                  ).addClass("active");
                }
                e.text(r + 1);
              }
        ...
        l(document).on(
          "keyup",
          "textarea.question_type_short_answer, textarea.question_type_open_ended",
          function (t) {
            var e = l(this);
            var r = e.val();
            var n = e.hasClass("question_type_short_answer")
            ...
            e.closest(".tutor-quiz-answers-wrap")
        ...
        l(document).on("click", "a", function (t) {
          ...
          if (
            t.target.classList.contains("sidebar-ask-new-qna-btn") ||
            t.target.classList.contains("tutor-quiz-question-paginate-item")
          ) {
            return;
          }
            ...
            var e = {
              ...
              buttons: {
                keep: {
                  ...
                  callback: function t() {
                    var e =
                      l("form#tutor-answering-quiz").serialize() +
                      "&action=" +
                      "tutor_quiz_abandon";
                    l.ajax({
                      ...
                      data: e,
                      beforeSend: function t() {
                        document.querySelector("#tutor-popup-leave").innerHTML =
                          u("Leaving...", "tutor");
                      },
                      success: function t(e) {
                        if (e.success) {
      ...
      window.jQuery(document).ready(function (n) {
        ...
        n(document).on("click", ".tutor-course-wishlist-btn", function (t) {
          ...
          n.ajax({
            url: _tutorobject.ajaxurl,
            type: "POST",
            data: { course_id: e, action: "tutor_course_add_to_wishlist" },
            beforeSend: function t() {
    ...
    6344: (t, e, r) => {
      ...
      window.jQuery(document).ready(function (o) {
        o('.tutor-settings-pass-field [name="confirm_new_password"]').on(
          "input",
          function () {
      ...
      window.jQuery(document).ready(function (a) {
        ...
        var t = function t(o) {
          ...
          this.update_preview = function (t, e) {
            var r = o.find(
              t == "cover_photo" ? "#tutor_cover_area" : "#tutor_profile_area"
            );
            if (!e) {
          ...
          this.toggle_profile_pic_action = function (t) {
            var e =
              t === undefined ? "toggleClass" : t ? "addClass" : "removeClass";
            o[e]("pop-up-opened");
          };
          ...
          this.toggle_loader = function (t, e) {
            o.find("#tutor_photo_meta_area .loader-area").css(
              "display",
              e ? "block" : "none"
            );
          };
          this.initialize = function () {
            ...
            o.find(
              "#tutor_profile_area .tutor_overlay, #tutor_pp_option>div:last-child"
            ).click(function () {
    ...
    787: () => {
      document.addEventListener("DOMContentLoaded", function () {
        var n = window.jQuery;
        n(
          '.tutor-dashboard-setting-withdraw input[name="tutor_selected_withdraw_method"]'
    ...
    1033: () => {
      ...
      jQuery(document).ready(function (c) {
        ...
        c("[tutor-instructors]").each(function () {
          ...
          a.on(
            "change",
            '[tutor-instructors-filter-category] [type="checkbox"]',
            function () {
              var t = {};
              c(this)
            ...
            .on("click", "[tutor-instructors-filter-clear]", function () {
              ...
              var e = document.querySelectorAll(
                "[tutor-instructors-filter-rating]"
              );
              var r = d(e),
                n;
              try {
        ...
        var l = document.querySelector(
          "[tutor-instructors-filter-rating-count]"
        );
        var o = d(s),
          i;
        try {
  ...
  (() => {
    dt.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e);
  })();
  (() => {
    dt.r = (t) => {
  ...
  (() => {
    ...
    function j() {
          ...
          (i._invoke = (function (i, a, u) {
            ...
            return function (t, e) {
              ...
              for (u.method = t, u.arg = e; ; ) {
                ...
                if ("normal" === o.type) {
                  if (
                    ((c = u.done ? "completed" : "suspendedYield"), o.arg === s)
                  )
                    continue;
      ...
      function w(u, c) {
        function s(t, e, r, n) {
          ...
          if ("throw" !== o.type) {
            var i = o.arg,
              a = i.value;
            return a && "object" == E(a) && l.call(a, "__await")
      ...
      return (
        ...
        i(g, "constructor", h),
        i(h, "constructor", f),
        (f.displayName = i(h, n, "GeneratorFunction")),
        ...
        (a.mark = function (t) {
          return (
            Object.setPrototypeOf
              ...
              : ((t.__proto__ = h), i(t, n, "GeneratorFunction")),
          ...
          dispatchException: function t(r) {
            ...
            function e(t, e) {
              return (
                ...
                (a.arg = r),
                (n.next = t),
                e && ((n.method = "next"), (n.arg = undefined)),
                !!e
              );
            }
      ...
      if (i) {
        i.onclick = function () {
          ...
          if (t.length) {
            ...
            tutor_toast(
              _("Warning", "tutor"),
              _("Nothing was selected for bulk action.", "tutor"),
              "error"
            );
                  ...
                  switch ((e.prev = e.next)) {
                    ...
                    case 11:
                      ...
                      if (a) {
                        tutor_toast(
                          _("Delete", "tutor"),
                          _("Course has been deleted ", "tutor"),
                          "success"
                        );
                        location.reload();
                      } else {
    ...
    document.addEventListener("DOMContentLoaded", function (t) {
      ...
      function g(t) {
        ...
        if (e === "touchstart") {
          ...
          if (o) {
            o.remove();
            var i =
              typeof t.originalEvent === "undefined" ? t : t.originalEvent;
            ...
            if (
              l.classList.contains("tutor-dropzone") ||
              l.closest(".tutor-dropzone")
            ) {
      ...
      function S() {
        ...
        var r =
          parseInt(
            (t = document.querySelector(
              'input[name="tutor_assignment_upload_limit"]'
            )) === null || t === void 0
              ? void 0
              : t.value
          ) || 0;
        ...
        if (L.files.length > a) {
          ...
          tutor_toast(
            h("Warning", "tutor"),
            h("Max ".concat(o, " file allowed to upload"), "tutor"),
            "error"
          );
          return;
        }
        if (e > r) {
          ...
          tutor_toast(
            h("Warning", "tutor"),
            h(
              "File size exceeds maximum limit ".concat(
                Math.floor(r / 1e6),
                " MB."
              ),
              "tutor"
        ...
        if ("files" in L) {
          if (L && L.files.length == 0) {
            ...
            for (var l = 0; l < a; l++) {
              ...
              u += '<div class="tutor-instructor-card '
                .concat(
                  f,
      ...
      var E = document.querySelectorAll(".tutor-attachment-file-close a");
      E.forEach(function (t) {
        t.onclick = (function () {
          var e = z(
            O().mark(function t(r) {
                  ...
                  switch ((e.prev = e.next)) {
                    ...
                    case 17:
                      ...
                      if (!s) {
                        tutor_toast(
                          h("Warning", "tutor"),
                          h("Attachment remove failed", "tutor"),
                          "error"
                        );
                      } else {
      ...
      function w(u, c) {
        function s(t, e, r, n) {
          ...
          if ("throw" !== o.type) {
            var i = o.arg,
              a = i.value;
            return a && "object" == P(a) && l.call(a, "__await")
              ? c.resolve(a.__await).then(
                  function (t) {
                    s("next", t, r, n);
                  },
    ...
    window.jQuery(document).ready(function (i) {
      ...
      var e = function t() {
        ...
        a.find("[action-tutor-clear-filter]")
          .closest(".tutor-widget-course-filter")
      ...
      i("[tutor-toggle-course-filter]").on("click", function (t) {
        ...
        if (i(".tutor-course-filter-backdrop").length == 0) {
          i("body").append(
            i(
              '<div class="tutor-course-filter-backdrop" area-hidden="true"></div>'
            )
              .hide()
              .fadeIn(150)
          );
    ...
    window.jQuery(document).ready(function (r) {
      r(document).on(
        ...
        function (t) {
          t.preventDefault();
          var e =
            r(this).data("login_url") ||
            r(this).closest(".tutor-course-entry-box-login").data("login_url");
          if (e) {
            window.location.assign(e);
          } else {
      ...
      function w(u, c) {
        function s(t, e, r, n) {
          ...
          if ("throw" !== o.type) {
            var i = o.arg,
              a = i.value;
            return a && "object" == D(a) && l.call(a, "__await")
              ? c.resolve(a.__await).then(
                  function (t) {
                    s("next", t, r, n);
                  },
    ...
    readyState_complete(function () {
      Object.entries(document.getElementsByTagName("a")).forEach(function (t) {
        ...
        if (
          (e !== null && e !== void 0 && e.includes("/logout")) ||
          (e !== null && e !== void 0 && e.includes("logout"))
        ) {
    ...
    jQuery(document).ready(function (a) {
       ...
       */ !(function (e) {
        ...
        if (((e.support.touch = "ontouchend" in document), e.support.touch)) {
          ...
          (t._touchStart = function (t) {
            var e = this;
            !n &&
              e._mouseCapture(t.originalEvent.changedTouches[0]) &&
              ((n = !0),
              (e._touchMoved = !1),
              r(t, "mouseover"),
              r(t, "mousemove"),
      ...
      a(".tutor-course-title h4 .toggle-information-icon").on(
        "click",
        function (t) {
          a(this)
      ...
      a(".tutor-course-topic.tutor-active")
      ...
      a(document).on(
        ...
        function (t) {
          t.preventDefault();
          a(".tutor-course-single-content-wrapper").toggleClass(
            "tutor-course-single-sidebar-hidden"
          );
        }
      );
      a("[tutor-course-topics-sidebar-offcanvas-toggler]").on(
        "click",
        function (t) {
          t.preventDefault();
          a(".tutor-course-single-content-wrapper").toggleClass(
      ...
      a("[tutor-hide-course-single-sidebar]").on("click", function (t) {
        t.preventDefault();
        console.log("Hello");
        a(".tutor-course-single-content-wrapper").removeClass(
          "tutor-course-single-sidebar-open"
        );
      ...
      if (jQuery.datepicker) {
        a(".tutor_report_datepicker").datepicker({ dateFormat: "yy-mm-dd" });
      }
      a(document).on(
        "submit",
          ...
          success: function t(e) {
            ...
            if (e.success) {
              ...
              if (e.data.available_balance !== "undefined") {
                a(".withdraw-balance-col .available_balance").html(
                  e.data.available_balance
                );
              }
              tutor_toast(
                i("Request Successful", "tutor"),
                i(
      ...
      a(document).on(
        "submit",
        "#tutor-dashboard-delete-element-form",
        function (t) {
          t.preventDefault();
      ...
      a(document).on("submit", "#tutor_assignment_submit_form", function (t) {
        ...
        if (e.trim().length < 1) {
          ...
          tutor_toast(
            i("Warning", "tutor"),
            i("Assignment answer is required.", "tutor"),
            "error"
          );
          setTimeout(function () {
            jQuery("button#tutor_assignment_submit_btn")
      ...
      a(document).on("change", "#tutor_profile_photo_file", function (t) {
        ...
        if (e.files && e.files[0]) {
          ...
          r.onload = function (t) {
            a(".tutor-profile-photo-upload-wrap")
              .find("img")
      ...
      function s() {
        a("ul.tutor-bp-enrolled-course-list").each(function () {
          ...
          if (e.length > n) {
            ...
            t.closest(".tutor-bp-enrolled-courses-wrap")
      ...
      a(document).on("click", "a.tutor_bp_plus_courses", function (t) {
        t.preventDefault();
        var e = a(this);
        e.closest(".tutor-bp-enrolled-courses-wrap")
