(function ($) {
  ...
  jQuery(document).ready(function ($) {
    ...
    $(".menu-toggle, .menu_toggle").on("click", function () {
      ...
      $(
        ".mobile_header .top_nav_mobile, .consulting_menu_nav .consulting_menu_nav"
      ).slideToggle(300);
      return false;
    });
    ...
    $(
      ".main_menu_nav > li.menu-item-has-children > .sub-menu > .menu-item-has-children > a"
    ).after('<span class="arrow"><i class="fa fa-chevron-down"></i></span>');
    $(".consulting_menu_nav > li.menu-item-has-children > a").after(
      '<i class="fa fa-plus arrow" aria-hidden="true"></i>'
    );
    $(".consulting_menu_nav > li ul > li.menu-item-has-children > a").after(
      '<i class="fa fa-plus arrow" aria-hidden="true"></i>'
    );

    $(
      ".main_menu_nav > li.menu-item-has-children .arrow, .consulting_menu_nav .menu-item-has-children .arrow"
    ).on("click", function () {
      let $this = $(this);
    ...
    $(
      ".header_style_1.sticky_menu #header .nav-box, .header_style_3.sticky_menu #header .nav-box, .header_style_4.sticky_menu #header .nav-box, .header_style_5.sticky_menu #header .nav-box, .header_style_6.sticky_menu #header .nav-box, .header_style_11.sticky_menu #header .nav-box, .header_style_12.sticky_menu #header .nav-box"
    ).affix({
      offset: {
        top: headerHeight,
      },
    ...
    $(
      ".header_style_2.sticky_menu #header .header-box, .header_style_10.sticky_menu #header .header-box"
    ).affix({
      offset: {
        top: headerHeight,
      },
    ...
    $("#wrapper").on("scroll", function () {
      if (
        $(".sticky_menu .header_top, .sticky_menu .nav-box").hasClass("affix")
      ) {
    ...
    $(".top_bar_info_switcher a").on("click", function () {
      ...
      $(this)
        .parents(".top_bar_info_wr")
        .find("#" + id)
        .show();
      $(this)
        .parents(".top_bar_info_wr")
        .find(".top_bar_info_switcher .active span")
        .text(title);
      $(this)
        .parents(".top_bar_info_wr")
        .find(".top_bar_info_switcher ul")
        .slideUp(100);
      return false;
    });
    ...
    $(".header_search_in_popup .search-icon").on("click", function () {
      ...
      $(".header_search_in_popup .search-form").append(
    ...
    $(".consulting-search button, .stm_top_bar_l13-search button").on(
      "click",
      function (e) {
        var $wr = $(this).closest(
          ".stm_top_bar_l13-search, .consulting-search"
        );
    ...
    $("body").on("click", function (e) {
      if (
        $(e.target).closest(".consulting-search, .stm_top_bar_l13-search")
          .length === 0
      ) {
