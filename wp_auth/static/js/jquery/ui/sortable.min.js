...
!(function (t) {
  ...
  return u.widget("ui.sortable", u.ui.mouse, {
    ...
    _setContainment: function () {
      ...
      "parent" === i.containment && (i.containment = this.helper[0].parentNode),
        ...
        /^(document|window|parent)$/.test(i.containment) ||
          ((t = u(i.containment)[0]),
          (i = u(i.containment).offset()),
          (e = "hidden" !== u(t).css("overflow")),
          (this.containment = [
            i.left +
            ...
            i.left +
              ...
              this.margins.left,
            i.top +
              (e ? Math.max(t.scrollHeight, t.offsetHeight) : t.offsetHeight) -
              (parseInt(u(t).css("borderTopWidth"), 10) || 0) -
    ...
    _trigger: function () {
      !1 === u.Widget.prototype._trigger.apply(this, arguments) &&
        this.cancel();
    },
    _uiHash: function (t) {
      var e = t || this;
