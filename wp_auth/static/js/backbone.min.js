...
!(function (n) {
      ...
      n[e] &&
        (i.prototype[e] = (function (n, t, s, r) {
          switch (t) {
            ...
            case 3:
              return function (t, e) {
                return n[s](this[r], P(t, this), e);
              };
            case 4:
              return function (t, e, i) {
                return n[s](this[r], P(t, this), e, i);
              };
            default:
              return function () {
  ...
  var o,
    ...
    n =
      ((e.on = function (t, e, i) {
        return (
          (this._events = a(n, this._events || {}, t, e, {
            context: i,
            ctx: this,
            listening: o,
          })),
          o &&
            (((this._listeners || (this._listeners = {}))[o.id] = o).interop =
              !1),
          this
        );
      }),
      ...
      function (t, e, i, n) {
        ...
        return (
          i &&
            ...
            e.push({ callback: i, context: s, ctx: s || r, listening: n })),
          t
        );
      }),
    l = function (t, e, i, n) {
    ...
    r =
      ...
      (e.stopListening = function (t, e, i) {
        ...
        if (n) {
          for (
            var s = t ? [t._listenId] : b.keys(n), r = 0;
            r < s.length;
            r++
          ) {
            var o = n[s[r]];
    ...
    d =
      ((e.once = function (t, e, i) {
        ...
        return this.on(
          n,
          (e = "string" == typeof t && null == i ? void 0 : e),
          i
        );
      }),
      ...
      (b.extend(v.prototype, e, {
        ...
        set: function (t, e, i) {
          if (null != t) {
            ...
            for (s in n)
              (e = n[s]),
                b.isEqual(u[s], e) || h.push(s),
                b.isEqual(l[s], e) ? delete c[s] : (c[s] = e),
                o ? delete u[s] : (u[s] = e);
            if (
              (this.idAttribute in n &&
                ((r = this.id),
              ...
              for (var d = 0; d < h.length; d++)
                this.trigger("change:" + h[d], this, u[h[d]], i);
            }
            if (!a) {
              if (!t)
                for (; this._pending; )
        ...
        save: function (t, e, i) {
          null == t || "object" == typeof t
            ...
            : ((n = {})[t] = e);
          var n,
            s = (i = b.extend({ validate: !0, parse: !0 }, i)).wait;
          if (n && !s) {
          ...
          var r = this,
            ...
            e =
              ("patch" != t || i.attrs || (i.attrs = n), this.sync(t, this, i));
        ...
        destroy: function (e) {
          ...
          return (
            this.isNew()
              ? b.defer(e.success)
              : (N(this, e), (t = this.sync("delete", this, e))),
            r || i(),
            t
          );
        },
        url: function () {
          var t,
            e =
              b.result(this, "urlRoot") ||
              b.result(this.collection, "url") ||
              M();
          return this.isNew()
            ? e
            : ((t = this.get(this.idAttribute)),
    ...
    y =
      (b.extend(m.prototype, e, {
        ...
        remove: function (t, e) {
          e = b.extend({}, e);
          var i = !b.isArray(t),
            t = ((t = i ? [t] : t.slice()), this._removeModels(t, e));
          return (
            !e.silent &&
              t.length &&
        ...
        set: function (t, e) {
          if (null != t) {
            ...
            for (
              var i = !b.isArray(t),
                n = ((t = i ? [t] : t.slice()), e.at),
                s =
                  ((n =
                    (n = null != n ? +n : n) > this.length ? this.length : n) <
                    0 && (n += this.length + 1),
                  []),
                r = [],
                o = [],
        ...
        _prepareModel: function (t, e) {
          return this._isModel(t)
            ...
            : (t = ((e = e ? b.clone(e) : {}).collection = this).model.prototype
                ? new this.model(t, e)
        ...
        _removeModels: function (t, e) {
          for (var i = [], n = 0; n < t.length; n++) {
            ...
            o &&
              ...
              null != (r = this.modelId(o.attributes, o.idAttribute)) &&
                delete this._byId[r],
        ...
        _onModelEvent: function (t, e, i, n) {
          if (e) {
            ...
            "destroy" === t && this.remove(e, n),
              "changeId" === t &&
                ((s = this.modelId(e.previousAttributes(), e.idAttribute)),
        ...
        delegateEvents: function (t) {
          if ((t = t || b.result(this, "events")))
            for (var e in (this.undelegateEvents(), t)) {
              var i = t[e];
              (i = b.isFunction(i) ? i : this[i]) &&
                ((e = e.match(A)), this.delegate(e[1], e[2], i.bind(this)));
            }
          return this;
        },
      ...
      (h.sync = function (t, e, n) {
        var i,
          ...
          r =
            ...
            { type: s, dataType: "json" }),
          o =
            (n.url || (r.url = b.result(e, "url") || M()),
            null != n.data ||
              !e ||
            ...
            !n.emulateHTTP ||
              ("PUT" !== s && "DELETE" !== s && "PATCH" !== s) ||
              ((r.type = "POST"),
              n.emulateJSON && (r.data._method = s),
              (i = n.beforeSend),
              (n.beforeSend = function (t) {
                if ((t.setRequestHeader("X-HTTP-Method-Override", s), i))
        ...
        return e.trigger("request", e, t, n), t;
      }),
      {
        create: "POST",
        update: "PUT",
      ...
      b.extend(R.prototype, e, {
        ...
        start: function (t) {
          ...
          this._hasHashChange ||
            ...
            (t = (t = document.body).insertBefore(
              this.iframe,
              t.firstChild
        ...
        navigate: function (t, e) {
          ...
          var i = this.root,
            i =
              ...
              t,
            n = ((t = t.replace(F, "")), this.decodeFragment(t));
          if (this.fragment !== n) {
